...
public class AnnunciLibriController {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "500", description = "Errore generico del server")})
	@PostMapping
	public ResponseEntity<Object> insert(@RequestParam String isbn, @RequestParam Float prezzo, @RequestParam Character livello_usura, @RequestParam Integer citta) {
		log.info("Invoked AnnunciLibriController.insert(" + isbn + ", " + prezzo + ", " + livello_usura + ", " + citta + ")");
